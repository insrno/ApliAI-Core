    ...
    <section id="evaluate" class="py-16 px-6">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex items-center justify-center gap-4 flex-wrap">
                ...
                <p class="text-xs text-gray-400 w-full text-center -mt-1">Google Gemini is temporarily locked while tuning reliability.</p>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="border-t border-gray-100 pt-8 mb-10">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <button id="generate-tips-btn" class="shrink-0 inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-colors text-xs font-semibold text-gray-600">
                ...
                <div class="mb-4 p-3 rounded-lg bg-gray-50 border border-gray-200">
                    <p class="text-xs text-gray-600 leading-relaxed">
                        Tips are personalized from your uploaded resume. Start with <span class="font-semibold">high-priority</span> items first, then re-run evaluation to improve your score and ATS keyword match.
                    </p>
                </div>
